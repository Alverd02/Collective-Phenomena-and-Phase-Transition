...
INTEGER SEED,i,n
REAL*8 x(40000),Mitjana,desvest2,desvest,jLATTICE(40000)
...
DO i=0,n
x(i) = genrand_real2()
jLATTICE(i) = ceiling(x(i)*8)
END DO

WRITE(*,*) x,jLATTICE
Mitjana=SUM(X)/n
WRITE(*,*) "Mitjana: ", Mitjana

DO i=0,n 
desvest2 = desvest2 + (X(i)-Mitjana)**2
END DO

desvest = sqrt(desvest2/n)

WRITE(*,*) "Desviacio: ", desvest

OPEN(11,file="p1-ex1.dat")
DO i=0,n 
WRITE(11,*) i,jLATTICE(i)
END DO
CLOSE(11)
